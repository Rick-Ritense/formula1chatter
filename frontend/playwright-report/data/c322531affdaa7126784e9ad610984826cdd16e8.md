...
- Name: Leaderboard Page >> should display race-specific results when race is selected
- Location: /Users/rickveenstra/workspace/cursor/formula1chatter/frontend/tests/leaderboard.spec.ts:95:3
...
Call log:
  - waiting for getByRole('button', { name: 'Race Results' })
    ...
    at /Users/rickveenstra/workspace/cursor/formula1chatter/frontend/tests/leaderboard.spec.ts:110:60
```
